...
-  *[bower][bower]* is meant to be consumed by higher-level tools and frameworks. What this means in practice is, **(1)** _bring your own CJS/AMD loader_. **(2)** _bring your own build tool_. **(3)** _bring your own organization conventions_.
